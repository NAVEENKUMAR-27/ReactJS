...
import { faLandmark, faLandmarkDome, faLocation, faLocationDot, faMagnifyingGlass } from "@fortawesome/free-solid-svg-icons";
        ...
        <div className="container-fluid">
          <div className="row pt-5">
               <div class="dropdown  col-lg-2">
                    <button class="  btn-sm  dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                            Experience
                    </button>
